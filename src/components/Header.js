            ...
            <div >
                <div className="w-[5%] flex  ">
                    <div  className="flex justify-center items-center absolute top-[50%] m-4">
                        <div onClick={() => setClick(!click)}  className="cursor-pointer  bg-white fixed  min-h-full w-[5%] left-0 top-0 flex justify-center items-center flex-col">
                    ...
                    <div   onClick={() => setClick(false)}  style={{
                        ...
                        <div className="bg-white fixed left-[5%] min-h-full w-3/12 flex  items-center flex-col">
                            <NavLink to="/">
                                <img className="m-20 " src={logo2} alt=""/>
                            </NavLink>
                            <div className="flex flex-col font-light text-2xl text-center color-black">
